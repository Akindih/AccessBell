...
export default function DoorbellUI() {
  ...
  useEffect(() => {
    fetch(`${API_BASE}/api/recordings`)
      ...
      .then(data => setRecordings(data.map(r => ({
        ...
        duration: "—",
        faces: [],   // face detection can be added later
        tagged: false,
        filename: r.filename,
      }))))
  ...
  const saveName = async (name) => {
    ...
    try {
      await fetch(`${API_BASE}/api/name-person`, {
        method: "POST",
  ...
  if (step === "list") return (
    <Page>
      ...
      {loading && (
        <div style={{
          background: "#EFF6FF", borderLeft: "6px solid #3B82F6",
          padding: "18px 28px", fontSize: 20, color: "#1E40AF",
            ...
            return (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  {knownNames.map((n, i) => (
                    <span key={i} style={pill("#D1FAE5", "#065F46")}>✓ {n}</span>
                  ))}
                  {unknownCount > 0 && (
    ...
    <Page>
      ...
      <Section>
        ...
        <div style={{
          ...
          background: "linear-gradient(160deg, #1c2a3a, #0e1825)",
          ...
          <div style={{
            position: "absolute", top: "15%", left: "38%", width: "24%", height: "78%",
            background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)",
            borderRadius: "6px 6px 0 0",
          }} />
          <div style={{
            position: "absolute", top: 14, left: 16, fontSize: 13,
          ...
          {selected.faces.length === 0 && (
            <div style={{
              ...
              display: "flex", alignItems: "center", justifyContent: "center",
              color: "rgba(255,255,255,0.35)", fontSize: 20, fontWeight: 600,
            }}>
              No faces were detected in this clip
            </div>
          )}
